...
<body>
    <div class="container mt-5" >
        <div class="card " style="box-shadow: 5px 5px 5px;">
            ...
            <div class="card-body">
                <form action="hlat12.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="namaLengkap" placeholder="Nama Lengkap" name="nama" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Jenis Kelamin</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jeniskelamin" id="lakiLaki" value="Laki-Laki" name="kelamin" required>
                                <label class="form-check-label" for="lakiLaki">Laki - Laki</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jeniskelamin" id="perempuan" value="Perempuan" name="kelamin">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tempatLahir" placeholder="Tempat Lahir" name="tempat" required>
                    </div>
                    <div class="mb-3">
                        <label for="tanggalLahir" class="form-label">Tanggal Lahir <span class="text-danger">*</span></label>
                        <input type="date" class="form-control" id="tanggalLahir" name="tanggal" required>
                    </div>
                    <div class="mb-3">
                        <label for="noHP" class="form-label">Nomor HP siswa yang bisa dihubungi <span class="text-danger">*</span></label>
                        <input type="tel" class="form-control" id="noHP" placeholder="HP" name="no" required>
                    </div>
                    <div class="mb-3">
        ...
        <div class="card " style="box-shadow: 5px 5px 5px;">
            ...
            <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="provinsi" class="form-select" name="prov" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="kabupatenKota" class="form-select" name="kab" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="kecamatan" class="form-select" name="kec" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="desaKelurahan" class="form-select" name="des" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="alamat" name="alamat" class="form-control" rows="3" placeholder="Tidak perlu lagi menulis provinsi, kota, kecamatan & kelurahan" required></textarea>
                    </div>
                    <div class="mb-3">
        ...
        <div class="card " style="box-shadow: 5px 5px 5px;">
            ...
            <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="alamat" class="form-control" rows="3" name="alamatsekolah" placeholder="Alamat Lengkap Asal Sekolah" required></textarea>
                    </div>
        ...
        <div class="card " style="box-shadow: 5px 5px 5px;">
            ...
            <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pekerjaan" placeholder="Pekerjaan" name="pekerjaan" required>
                    </div>
                    <div class="mb-3">
                        <label for="nomorHP" class="form-label">Nomor HP yang bisa dihubungi <span class="text-danger">*</span></label>
                        <input type="tel" class="form-control" id="nomorHP" placeholder="Nomor HP" name="nohp" required>
                    </div>
                    <div class="mb-3">
                        <label for="alamatLengkap" class="form-label">Alamat Lengkap <span class="text-danger">*</span></label>
                        <textarea id="alamatLengkap" class="form-control" rows="3" placeholder="Alamat Lengkap" name="alamatL" required></textarea>
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary" name="submit">Simpan & Daftar</button>
                    </div>
                </form>
            </div>
        </div>
